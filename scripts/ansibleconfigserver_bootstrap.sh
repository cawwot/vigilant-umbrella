...
qs_retry_command 25 aws s3 cp s3://dsocloudformation/quickstart-redhat-openshift-master/scripts/redhat_ose-register-${OCP_VERSION}.sh ~/redhat_ose-register.sh
...
qs_retry_command 10 aws s3 cp s3://dsocloudformation/quickstart-redhat-openshift-master/scripts/scaling/aws_openshift_quickstart/__init__.py /root/ose_scaling/aws_openshift_quickstart/__init__.py
qs_retry_command 10 aws s3 cp s3://dsocloudformation/quickstart-redhat-openshift-master/scripts/scaling/aws_openshift_quickstart/logger.py /root/ose_scaling/aws_openshift_quickstart/logger.py
qs_retry_command 10 aws s3 cp s3://dsocloudformation/quickstart-redhat-openshift-master/scripts/scaling/aws_openshift_quickstart/scaler.py /root/ose_scaling/aws_openshift_quickstart/scaler.py
qs_retry_command 10 aws s3 cp s3://dsocloudformation/quickstart-redhat-openshift-master/scripts/scaling/aws_openshift_quickstart/utils.py /root/ose_scaling/aws_openshift_quickstart/utils.py
qs_retry_command 10 aws s3 cp s3://dsocloudformation/quickstart-redhat-openshift-master/scripts/scaling/bin/aws-ose-qs-scale /root/ose_scaling/bin/aws-ose-qs-scale
qs_retry_command 10 aws s3 cp s3://dsocloudformation/quickstart-redhat-openshift-master/scripts/scaling/setup.py /root/ose_scaling/setup.py

qs_retry_command 10 aws s3 cp s3://dsocloudformation/quickstart-redhat-openshift-master/scripts/predefined_openshift_vars_${OCP_VERSION}.txt /tmp/openshift_inventory_predefined_vars
qs_retry_command 10 aws s3 cp s3://dsocloudformation/quickstart-redhat-openshift-master/scripts/scaling/aws_openshift_quickstart/unsubscribe.py /root/unsubscribe.py
...
qs_retry_command 10 aws s3 cp s3://dsocloudformation/quickstart-redhat-openshift-master/scripts/scaleup_wrapper.yml  /usr/share/ansible/openshift-ansible/
qs_retry_command 10 aws s3 cp s3://dsocloudformation/quickstart-redhat-openshift-master/scripts/bootstrap_wrapper.yml /usr/share/ansible/openshift-ansible/
qs_retry_command 10 aws s3 cp s3://dsocloudformation/quickstart-redhat-openshift-master/scripts/playbooks/post_scaledown.yml /usr/share/ansible/openshift-ansible/
qs_retry_command 10 aws s3 cp s3://dsocloudformation/quickstart-redhat-openshift-master/scripts/playbooks/post_scaleup.yml /usr/share/ansible/openshift-ansible/
qs_retry_command 10 aws s3 cp s3://dsocloudformation/quickstart-redhat-openshift-master/scripts/playbooks/pre_scaleup.yml /usr/share/ansible/openshift-ansible/
qs_retry_command 10 aws s3 cp s3://dsocloudformation/quickstart-redhat-openshift-master/scripts/playbooks/pre_scaledown.yml /usr/share/ansible/openshift-ansible/
qs_retry_command 10 aws s3 cp s3://dsocloudformation/quickstart-redhat-openshift-master/scripts/playbooks/remove_node_from_etcd_cluster.yml /usr/share/ansible/openshift-ansible/
